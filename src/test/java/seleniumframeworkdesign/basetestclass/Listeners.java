...
import seleniumframeworkdesign.globalproperty.ExtentReportConfiguration;
...
public class Listeners  extends BaseTest implements ITestListener{
	...
	try {
		 destinationPath = getScreenShot(result.getMethod().getMethodName(),driver); //Taking the screenshot, storing it in a local directory and returning and storing the path to the screenshot in a string variable 'destinationPath'
	} catch (IOException e) {
		// TODO Auto-generated catch block
		e.printStackTrace();
	}
